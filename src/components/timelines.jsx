        ...
        <section className="colorlib-experience" data-section="timelines">
          <div className="colorlib-narrow-content">
            ...
            <Timeline lineColor={'#ddd'}>
              <TimelineItem key="001" dateText="July 2019 - Present" dateInnerStyle={{ background: '#61b8ff', color: '#000' }} style={{ color: '#61b8ff' }}>
                <h3>Apps Programmer, Wells Fargo Centre</h3><br></br>
                <p>Joined Wells Fargo, Hyderabad as an Apps Programmer/Analyst 2.</p>
              </TimelineItem>

              <TimelineItem key="002" dateText="May 2018 – July 2018" style={{ color: '#e86971' }}>
              ...
              <TimelineItem key="003" dateText="January 2018 – May 2018" dateInnerStyle={{ background: '#61b8ff', color: '#000' }} style={{ color: '#61b8ff' }}>
              ...
              <TimelineItem key="004" dateText="July 2015 – May 2019" style={{ color: '#e86971' }}>
                <h3>B.Tech, NIT Silchar</h3><br></br>
                <p>I have completed my B.Tech degree course with major in Computer Science and Engineering. My courseworks included DSA, OOPs, Computer Networks, OS, DBMS etc. I have also been an integral part of the Computer Science Society.</p>
              </TimelineItem>

              <TimelineItem key="005" dateText="2003 – 2015" dateInnerStyle={{ background: '#61b8ff', color: '#000' }} style={{ color: '#61b8ff' }}>
