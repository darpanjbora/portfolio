        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Darpan Jyoti Bora</a></h1>
              <span className="email"><i className="icon-mail"></i> Darpanjyoti.bora@gmail.com</span>
            </div>
            <br></br>
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#timelines" data-nav-section="timelines">Timeline</a></li>
                </ul>
              </div>
            </nav>
            <br></br>
